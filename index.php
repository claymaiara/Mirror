<link rel="stylesheet" href="css/painel-compacto.css">
	...
	<div class="container destaque">
		<section class="busca">
			...
			<form action="http://www.google.com.br/search" id="form-busca">
				<input type="search" name="q" id="q"> <input type="image"
					src="img/busca.png">
			</form>
		</section>
		<!-- FIM DA .busca -->
		...
		<img alt="Promoção: Big City Night" src="img/destaque-home.png"> <a
			href="#" class="pause"></a>
	</div>
			...
			<li><a href="produto.php?id=<?= $produto[id]?>">
						<figure>
							<img alt="<?= $produto["nome"]?>"
								src="img/produtos/miniatura<?= $produto["id"]?>.png">
